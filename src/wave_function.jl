...
function WaveFunction_Matfree2(ne::Int, ham::Hamiltonian; kdim=10, maxiter=100)
   ...
   Ψtensor, phihtensor, phimtensor, phiAtensor1, phiBtensor1, phiCtensor1, W, M1, MA1, MC1 = preallocate2(ne, N)
   ...
   M_Ψ(Ψ::Array{Float64,1}) = ham_free_tensor!(
      ...
      Ψtensor, phihtensor, phimtensor, phiAtensor1, phiBtensor1, phiCtensor1, W, M1, MA1, MC1)
